...
# R-squared
the model's Multiple R-squared is 0.1622 which means that the model only explains 16% life expectancy so the model is not a good one.
...
```
after trying to overfit the model the  R-squared increases to .17 which is not efficient as well.
...
1- ee can see that confidence interval for **intercept** is between 64.7308102 and 65.9022146 which means that 95% of the Intercept lies in this range.
