...
# add status_numeric as anew cloumns becuase cor function use only numerical data
...
Similarity, the Confidence Interval for GDP and total expentiture are tiny. This indicates that the schooling is precise estimated.
